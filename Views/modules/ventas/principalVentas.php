		  ...
		  <br>
			 <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
			   <!--  <div class="btn-group mr-2" role="group" aria-label="First group"> -->
				<a href="mesa1" class="btn btn-primary">Mesa 1</a>
				<a href="mesa2" class="btn btn-primary">Mesa 2</a>
				<a href="mesa3" class="btn btn-primary">Mesa 3</a>
				<br><br>
				<a href="mesa4" class="btn btn-primary">Mesa 4</a>
				<a href="mesa5" class="btn btn-primary">Mesa 5</a>
				<a href="mesa6" class="btn btn-primary">Mesa 6</a>
				<br><br>
				<a href="mesa7" class="btn btn-primary">Mesa 7</a>
				<a href="mesa8" class="btn btn-primary">Mesa 8</a>
				<a href="mesa9" class="btn btn-primary">Mesa 9</a>
				<br><br>
				<a href="mesa10" class="btn btn-primary">Mesa 10</a>
		...
		<div class="col-lg-8">
		   <?php 
             if (isset($_GET['action'])) {
	             ...
	             echo '<br><img src="assets/img/foto1.jpg" width="350" height="350" >';
             	}
